...
// V4: derived_available_count=0 in fallback so D1-down state shows everything as 售完
// instead of accepting orders we can't fulfil. Real stock comes from D1.
// V5.2: shape updated for group fen pool model — group_stock_fen=0 → derived count=0.
